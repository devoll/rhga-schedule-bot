...
# Копируем .env.example, чтобы иметь шаблон переменных окружения
# Фактический .env файл или переменные окружения должны быть предоставлены при запуске контейнера
